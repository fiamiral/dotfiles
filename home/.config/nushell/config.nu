...
$env.config = {
    ...
    datetime_format: {
        ...
        table: '%Y-%m-%dT%H:%M'          # generally shows up in tabular outputs such as ls. commenting this out will change it to the default human readable datetime format
    }
...
# Starship
# REF: https://www.nushell.sh/book/3rdpartyprompts.html#starship
